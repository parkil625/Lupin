...
export default function Ranking() {
  ...
  const topRankers = [
    { rank: 1, name: "이철수", points: 520, avatar: "이", profileImage: "https://images.unsplash.com/photo-1507003211169-0a1dd7228f2d?w=150&h=150&fit=crop" },
    { rank: 2, name: "박영희", points: 480, avatar: "박", profileImage: "https://images.unsplash.com/photo-1494790108377-be9c29b29330?w=150&h=150&fit=crop" },
    { rank: 3, name: "최민수", points: 450, avatar: "최", profileImage: "https://images.unsplash.com/photo-1500648767791-00dcc994a43e?w=150&h=150&fit=crop" },
  ...
  const myRankers = [
    { rank: 52, name: "이민정", points: 145, avatar: "이", profileImage: "https://images.unsplash.com/photo-1544005313-94ddf0286df2?w=150&h=150&fit=crop" },
    { rank: 53, name: "김루핀", points: 138, avatar: "김", isMe: true },
    { rank: 54, name: "박서준", points: 125, avatar: "박", profileImage: "https://images.unsplash.com/photo-1492562080023-ab3db95bfbce?w=150&h=150&fit=crop" },
  ];
