...
// Named Export를 Lazy로 불러오는 패턴
const NotFoundPage = lazy(() => import("./components/errors").then(module => ({ default: module.NotFoundPage })));
const ErrorPage = lazy(() => import("./components/errors").then(module => ({ default: module.ErrorPage })));
