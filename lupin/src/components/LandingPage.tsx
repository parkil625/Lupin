...
const SERVICE_CARDS = [
  {
    icon: Target,
    title: "점수 획득 시스템",
    desc: "운동을 완료하고 점수를 획득하세요. 점수에 따라 실시간 랭킹이 변동됩니다!",
    color: "from-[#C93831] to-pink-500",
  },
  {
    icon: MessageCircle,
    title: "비대면 진료",
    desc: "전문 의료진과 1:1 채팅으로 간편하게 비대면 진료를 받으세요!",
    color: "from-purple-500 to-pink-500",
  },
  {
    icon: BarChart3,
    title: "실시간 랭킹",
    desc: "점수 기반 실시간 랭킹에서 다른 동료들과 경쟁하고 성장하세요!",
...
const KEY_FEATURES = [
  {
    icon: Users,
    title: "데일리 피드",
    desc: "하루 한 번 운동 관련 피드를 작성하고 공유하세요",
    color: "from-[#C93831] to-pink-500",
  },
  {
    icon: Heart,
    title: "좋아요",
    desc: "다른 사용자의 피드에 좋아요를 누르고 응원하세요",
    color: "from-pink-500 to-purple-500",
  },
  {
    icon: BarChart3,
    title: "랭킹",
    desc: "점수에 따른 실시간 랭킹을 확인하세요",
    color: "from-purple-500 to-blue-500",
  },
  {
    icon: Trophy,
    title: "배지",
    desc: "TOP 10 등 특별 배지를 획득하세요",
    color: "from-yellow-400 to-orange-500",
  },
  {
    icon: Search,
    title: "피드 검색",
    desc: "피드를 검색하고 필터링할 수 있습니다",
    color: "from-blue-500 to-cyan-500",
  },
  {
    icon: Calendar,
    title: "진료 예약",
    desc: "비대면 진료를 예약하고 관리할 수 있습니다",
    color: "from-cyan-500 to-teal-500",
  },
  {
    icon: MessageCircle,
    title: "비대면 진료",
    desc: "1:1 채팅을 통해 비대면으로 진료를 받을 수 있습니다",
    color: "from-teal-500 to-green-500",
  },
  {
    icon: FileText,
    title: "처방전 확인",
    desc: "받은 처방전을 확인하고 관리할 수 있습니다",
    color: "from-green-500 to-lime-500",
  },
  {
    icon: Zap,
    title: "포인트 시스템",
    desc: "활동에 따라 포인트를 획득하고 순위에 도전하세요",
    color: "from-orange-500 to-red-500",
  },
  {
    icon: UserCircle,
    title: "마이페이지",
    desc: "개인 건강 정보를 수정하고 관리할 수 있습니다",
          ...
          <div className="grid md:grid-cols-2 gap-8 md:gap-12 items-center">
            <div className="space-y-4 md:space-y-6 order-2 md:order-1">
              ...
              <h1 className="text-3xl sm:text-4xl md:text-5xl lg:text-6xl font-black text-gray-900 leading-tight tracking-tight">
                건강한 습관,
                <br />
                <span className="text-transparent bg-clip-text bg-gradient-to-r from-[#C93831] to-pink-500">
                  함께 만들어가요
                </span>
              </h1>
              ...
              <div className="flex gap-3 md:gap-8 pt-2 md:pt-4">
                {HERO_STATS.map((item, idx) => (
                  <div
                    key={idx}
                    className="backdrop-blur-xl bg-white/40 rounded-xl md:rounded-2xl p-3 md:p-4 border border-white/60"
                  >
                    <div className="text-xl md:text-3xl font-black text-[#C93831]">
                      {item.title}
                    </div>
      ...
      <section className="py-12 md:py-20 px-4 scroll-fade-up">
        <div className="container mx-auto max-w-6xl">
          <div className="text-center mb-8 md:mb-16">
            <h2 className="text-3xl md:text-5xl font-black text-gray-900 mb-2 md:mb-4">
              Lupin이 특별한 이유
            </h2>
            <p className="text-base md:text-xl text-gray-700 font-medium">
              운동 기록부터 비대면 진료까지, 건강 관리가 즐거워집니다
            </p>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-4 md:gap-8">
            {SERVICE_CARDS.map((card, i) => (
              <Card
                key={i}
                className="backdrop-blur-2xl bg-white/40 border border-white/60 shadow-xl hover:shadow-2xl transition-all hover:-translate-y-2"
              >
                <CardContent className="p-6 md:p-8 space-y-3 md:space-y-4">
                  <div
                    className={`w-12 h-12 md:w-14 md:h-14 bg-gradient-to-br ${card.color} rounded-xl md:rounded-2xl flex items-center justify-center shadow-lg`}
                  >
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8 md:gap-12 items-center">
            ...
            <div className="space-y-4 md:space-y-6">
              ...
              <p className="text-base md:text-xl text-gray-700 font-medium break-keep">
                운동이 끝나면 바로 기록하세요. 운동 시간과 종류에 따라 점수를
                받을 수 있습니다.
              </p>
              <div className="space-y-4">
                {ACTIVITY_STEPS.map((text, idx) => (
                  <div
                    key={idx}
                    className="flex items-center gap-3 backdrop-blur-xl bg-white/40 p-4 rounded-2xl border border-white/60"
                  >
            ...
            {KEY_FEATURES.map((feature, index) => (
              ...
              >
                <CardContent className="p-4 md:p-6 text-center space-y-2 md:space-y-4">
                  <div
                    className={`w-10 h-10 md:w-14 md:h-14 bg-gradient-to-br ${feature.color} rounded-xl md:rounded-2xl flex items-center justify-center mx-auto shadow-lg`}
                  >
                  ...
                  <p className="text-xs md:text-sm text-gray-700 font-medium hidden sm:block break-keep">
                    {feature.desc}
                  </p>
                </CardContent>
              </Card>
          ...
          <div className="grid grid-cols-3 gap-3 md:gap-6">
            {HOW_IT_WORKS.map((item, index) => (
              <div key={index} className="text-center space-y-2 md:space-y-4">
                <div
                  className={`w-14 h-14 md:w-20 md:h-20 bg-gradient-to-br ${item.color} text-white rounded-2xl md:rounded-3xl flex items-center justify-center mx-auto text-xl md:text-3xl font-black shadow-2xl`}
                >
                  {item.step}
                </div>
                <item.icon className="w-6 h-6 md:w-10 md:h-10 text-[#C93831] mx-auto" />
                <h3 className="text-sm md:text-xl font-black text-gray-900">
                  {item.title}
                </h3>
                <p className="text-xs md:text-sm text-gray-700 font-medium hidden sm:block">
                  {item.desc}
                </p>
              </div>
            ))}
            ...
            <div className="pt-4 md:pt-8 flex items-center justify-center gap-6 md:gap-12">
              {CTA_BADGES.map((badge, idx) => (
                <div key={idx} className="text-center">
                  ...
                  <div className="text-xs md:text-sm text-red-100 font-bold">
                    {badge.text}
                  </div>
                </div>
              ))}
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6 md:gap-8 mb-6 md:mb-8">
            <div className="space-y-3 md:space-y-4 text-center md:text-left">
              <img
                ...
                width="100"
                height="32"
                className="h-8 md:h-10 w-auto object-contain mx-auto md:mx-0"
              />
            ...
            <div className="text-center md:text-left">
              <h3 className="text-white font-black mb-2 md:mb-4 text-sm md:text-base">
                회원 기능
              </h3>
